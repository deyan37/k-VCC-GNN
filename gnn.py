...
class GNN(torch.nn.Module):
    ...
    def __init__(self, num_tasks, num_layer = 5, emb_dim = 300,
                    gnn_type = 'gin', virtual_node = True, residual = False, drop_ratio = 0.5, JK = "last", graph_pooling = "mean", dataset = 'ogbg'):
        '''
        ...
        if virtual_node:
            ...
            self.gnn_node = GNN_node(num_layer, emb_dim, JK = JK, drop_ratio = drop_ratio, residual = residual, gnn_type = gnn_type, dataset = dataset).to(device)
